...
sleep 1
#s1
curl -X POST -d '{"switch":"00:00:00:00:00:00:00:01", "name":"s1-src-sink-update", "priority":"2", "eth_vlan_vid":"0x1001", "active":"true", "actions":"pop_vlan,set_field=eth_dst->00:00:00:00:00:02,set_field=ipv4_dst->192.168.1.2,output=1"}' http://localhost:8080/wm/staticentrypusher/json
sleep 1
#s2
